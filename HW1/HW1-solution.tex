...
\begin{enumerate}
    \item
        ...
        \begin{tikzpicture}[font=\sffamily,>=triangle 45]
            ...
            \node [not gate US, draw] at (0,1.5) (xnot) {};
            \node [and gate US, draw] at (1,0) (and1) {};
            \node [and gate US, draw] at (1,0.5) (and2) {};
            \node [and gate US, draw, logic gate inputs=nnn] at (1,1) (and3) {};
            \node [or gate US, draw, logic gate inputs=nnn] at (4,1.5) (or1) {};
