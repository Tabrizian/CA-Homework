...
\begin{homeworkProblem}
    ...
    \begin{homeworkSection}{(b)}
        \problemAnswer{
           With LRU replacement policy you the hit rate will be the zero because
           the in the second round all of the requiered addresses will be filled
           sequentially and none of the address will be hitted.\\
